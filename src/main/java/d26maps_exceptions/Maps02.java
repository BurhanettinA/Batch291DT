...
// Key Map’te zaten varsa, metodun hiçbir etkisi olmaz.
        ...
        stdAges.putIfAbsent("Ayse", 23);// Ayse ekleniyor
        System.out.println(stdAges);

        stdAges.putIfAbsent("Aysee", 23);
        System.out.println(stdAges);
...
// bir varsayılan değer sağlama avantajına sahiptir.
        ...
        //Map`te Jerry yok,default degeri
...
//https://emojipedia.org/
        ...
        //--------------------
//6) remove():bu metot key kullanarak entry silmeye yarar.
        stdAges.remove("Tom")  ;
        System.out.println(stdAges);//{Can=19, Ahmet=41, Veli=63, Ayse=23, Aysee=23, Ali=18}Tom ve valuesi silindi

        stdAges.remove("Can",18);
        System.out.println(stdAges);//{Can=19, Ahmet=41, Veli=63, Ayse=23, Aysee=23, Ali=18}
        //Can 18 diye bir value olmadigi icin Can`i silemez.Hem Can hem de 18 in eslesmesi lazim.
