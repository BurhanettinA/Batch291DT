...
*/
        ...
        System.out.println(mylist);//[Ali, Veli, Ayse, Fatma] dikkat insertion order denir.eklemesirasina göre verir.
        ...
        System.out.println(linkedList); //[Eleman1, Eleman2, Eleman3] cok kullanilmaz liste esnek ama dikkat , dinamik bir yapi ekleme yapialbilir

        LinkedList<String> linkedList2 = new LinkedList<>(List.of("Eleman1", "Eleman2", "Eleman3"));// buda esnek
        System.out.println(linkedList2);//[Eleman1, Eleman2, Eleman3] bunlar kisa yollar.
        ...
        /*
         List<String>  immutablelist = List.of("Eleman1", "Eleman2", "Eleman3");// degistirilemez, eklenemz, cikarilamaz,
        immutablelist.add("serkan");// buraada serkan eklenemez, bu daha cok aylar vs icin kullanilir, sabit olan veriler.
        System.out.println(immutablelist);// accept
         */
        //------------------------------------------
        ...
        mylist.add("Hasan");
        System.out.println(mylist);//[Ali, Zeynep, Veli, Ayse, Fatma, Hasan]
       ...
       mylist.addLast("Huseyin");
        ...
        boolean m1 = mylist.remove("Ali");// buyuk kucuk harf duyarli
    ...
    mylist.add("Yusuf");
    mylist.add(3, "Yusuf");
    System.out.println(mylist);//[Zeynep, Veli, Ayse, Yusuf, Fatma, Hasan, Huseyin, Yusuf]
       ...
       System.out.println(mylist);//[Zeynep, Veli, Ayse, Fatma, Hasan, Huseyin, Yusuf]
...
// Bu metod, koleksiyon boşsa null dondurur
        ...
        System.out.println(s);//Zeynep
        System.out.println(mylist);//[Zeynep, Veli, Ayse, Fatma, Hasan, Huseyin]

//9)poll() metodu, bir koleksiyonun başındaki elemanı alır ve koleksiyondan kaldırır.
// Bu metod, koleksiyon boşsa null döndürür.

        System.out.println(mylist.poll());//Zeynep
        System.out.println(mylist);//[Veli, Ayse, Fatma, Hasan, Huseyin]
        ...
        System.out.println(mylist.element());//Veli
        System.out.println(mylist);//[Veli, Ayse, Fatma, Hasan, Huseyin]
        ...
        System.out.println(mylist.pop());//Veli

        System.out.println(mylist);//[Ayse, Fatma, Hasan, Huseyin]
