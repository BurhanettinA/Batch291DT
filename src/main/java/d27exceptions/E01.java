...
public class E01 {
     ...
     */
        //ArithmeticException:Matemetik kurallarinda herhangibir hata yaparsaniz bu Exceptionu alirsiniz.
        // division(5,0);
       // division2(7, 0);
          division3(7,0);
    }// main disi
    ...
    public static void division2(int a, int b) {
        try {
            ...
            System.out.println("Lütfen sifira bölme islemi yapmayiniz");
        }
        System.out.println("try catch sonrasi kod, akisina devam ediyor");//Tryda hata yoksa catch calismaz.
        //Eger try bolumunde hata ile karsilasilirsa hata alinan satirda calisma durdurulur.
        //ve catch bolumu calismaya baslar.
    }
    //----------------------
    //Throw Exception:Exceptionu kullanici firlatir.
