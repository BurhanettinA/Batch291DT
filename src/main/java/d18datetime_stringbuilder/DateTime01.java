...
public class DateTime01 {
    public static void main(String[] args) {
        ...
        /*
        ARASTIRMA ÖDEVI
                JAVA BU BILGIYI NEREDEN CEKIYOR: TOKYO DA AYIN KACI: BU BILGIYI INTERNEETEN MI CEKIYOR
                SAAT BILGISINI TARIH BILGISINI NEREDEN CEKIYOR:
                 */
...
//Zaman dilimlerinin sayisini gorelim
     ...
     */
        ...
        System.out.println(formattedLdt);//04 * Okt. *2024 - 10 :51 AM
